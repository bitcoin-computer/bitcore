...
describe('Script', function() {
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      var address = Address.fromString('LQqWdV81RmiEzXoACvWDQPZEXXU1Q16suH');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0x3d9234bc6ecfba9bc9f1fa8beb75f79b4ac0fc37 OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress().toString().should.equal('LQqWdV81RmiEzXoACvWDQPZEXXU1Q16suH');
    });
    it('should create script from testnet address', function() {
      var address = Address.fromString('n4EBp7wXjSKhDWegYUWzLP7943gf7kFyeh');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0xf91f1b33b56008f7ace83ca904d24e71e7cf5b89 OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress().toString().should.equal('n4EBp7wXjSKhDWegYUWzLP7943gf7kFyeh');
    });
  ...
  describe('#buildScriptHashOut', function() {
    ...
    it('inherits network property from other script', function() {
      var s1 = new Script.fromAddress(new Address('LQqWdV81RmiEzXoACvWDQPZEXXU1Q16suH'));
      var s2 = Script.buildScriptHashOut(s1);
      should.exist(s1._network);
      s1._network.should.equal(s2._network);
    });

    it('inherits network property from an address', function() {
      var address = new Address('Qc2auTnCPT7dztNx8zK6vW8nDFZncJeW28');
  ...
  describe('getData returns associated data', function() {
    ...
    it('for a P2SH address', function() {
      var address = Address.fromString('Qc2auTnCPT7dztNx8zK6vW8nDFZncJeW28');
  ...
  describe('toAddress', function() {
    ...
    it('for a P2PKH address', function() {
      var stringAddress = 'LQqWdV81RmiEzXoACvWDQPZEXXU1Q16suH';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    it('for a P2SH address', function() {
      var stringAddress = 'Qc2auTnCPT7dztNx8zK6vW8nDFZncJeW28';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    ...
    it('works for p2pkh output', function() {
      // taken from tx b05a2dc0e92c0bb0c3b77e0e9ac7e72683b9d5a01fd91e99bb629a144ec60488
      var script = new Script('OP_DUP OP_HASH160 20 0x74fa1f986021441b6706940e19b88e63aa2b3ae5 OP_EQUALVERIFY OP_CHECKSIG');
      script.isPublicKeyHashOut().should.be.true;
      script.toAddress().toString().should.equal('LVtUHLyMDyNzBuoBrcamjwoySvWaRW93Pt');
    });
    it('works for p2pkh input', function() {
      // taken from tx b05a2dc0e92c0bb0c3b77e0e9ac7e72683b9d5a01fd91e99bb629a144ec60488
      var script = new Script('71 0x3045022100a18707690dbfc4f7225de118d8fd916a78eff5496a4f483d73e3338985baeb9102206bc4e28a1401928cd03126c78d8e7b9cbc6b53f8f8bbff7d058ae40cd1e6f25001 33 0x037897d87856789538543ba6fca6bd4984e79d09eb23ac5b7046be8ef5185debe0');
      script.isPublicKeyHashIn().should.be.true;
      script.toAddress().toString().should.equal('LLciwhggzEUTE5QDzeYS39djph7Z897KJH');
      // taken from tx 3733f83f5c2717ab6228d529c5eed4b7ce7d8b2f1d83b0fc1d23a9f0573dbcfa
      var s2 = new Script('71 0x304502210092e0d147fa55994926f85c64ccbfa485dde9b3418223dab48ea54aa84c2a7dd3022044638785d82c7e0e5919eb1837861de660c9fc0e4932dc989f898669bdc60acc01 33 0x033887173addda55bc32db179aa89ef62fa73d87d917df0fa940ad769e992ead33');
      s2.isPublicKeyHashIn().should.be.true;
      s2.toAddress().toString().should.equal('LeJWTN1pZaJPg5mBjMqskjTaagD2k4ijY6');
    });

    it('works for p2sh output', function() {
      // taken from tx bf1fa6f30f6e62813f81fc5abb46591c52c83b8f6eabc3286f7d4843895941cd
      var script = new Script('OP_HASH160 20 0x1e2373a3a73f167952c5dfd4b25f1998503970dd OP_EQUAL');
      script.isScriptHashOut().should.be.true;
      script.toAddress().toString().should.equal('MAeWyQwHPaURpZsWUGJ2RJpkaRPcSWd78i');
    });
    it('works for p2sh input', function() {
      ...
      script.isScriptHashIn().should.be.true;
